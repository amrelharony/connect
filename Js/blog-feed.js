...
(function() {
    ...
    async function renderFeed() {
      ...
      <div class="lb-wrap" style="max-width:900px">
        ...
        // Bind nav
        document.getElementById('lbBrandHome').addEventListener('click', e => { e.preventDefault(); B.goToPortfolio(); });
        document.getElementById('lbBrandHome').addEventListener('keydown', e => { if (e.key === 'Enter') { e.preventDefault(); B.goToPortfolio(); } });
