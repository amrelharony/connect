...
function launch(){
    ...
    gsap.to(app,{opacity:1,duration:.5,delay:.1});setTimeout(function(){updStatus();_showPeripherals();},1000);
...
(function ContentHubTabs() {
  ...
  tabCSS.textContent = '.ch-feed{flex-direction:column;gap:12px;margin-bottom:12px;display:none}' +
