...
(async function(){
    ...
    const _wUrl='https://api.open-meteo.com/v1/forecast?latitude=30.0444&longitude=31.2357&current=temperature_2m,weather_code,is_day&timezone=Africa%2FCairo';
    ...
    function parseRes(json){return{temp:json.current.temperature_2m,code:json.current.weather_code,isDay:!!json.current.is_day};}
