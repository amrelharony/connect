...
(function PhaseSixIntelligence() {
  ...
  function initAlwaysCTA() {
    ...
    row.innerHTML = `
      ...
      <a href="https://adplist.org/mentors/amr-elharony?session=46534-mentorship-session" target="_blank" rel="noopener"
        ...
        <img src="Assets/Adplist.svg" alt="ADPList" style="width:18px;height:18px;object-fit:contain;vertical-align:middle;"> Get Mentored
      </a>`;
  ...
  function initVoiceNav() {
    ...
    const btn = document.getElementById('voiceBtn') || (() => {
      ...
      b.className = 'tbtn voice-tbtn'; b.id = 'voiceBtn';
      b.setAttribute('aria-label','Voice Navigation'); b.title = 'Voice Command (V)';
      b.innerHTML = '<i class="fa-solid fa-microphone-slash" id="voiceIcon"></i>';
      const audioBtnRef = document.getElementById('audioBtn');
      if (audioBtnRef) audioBtnRef.insertAdjacentElement('afterend', b);
      else { const themeBtnRef = document.getElementById('tbtn'); if (themeBtnRef) themeBtnRef.insertAdjacentElement('afterend', b); else document.getElementById('topBtns')?.appendChild(b); }
      return b;
    })();
