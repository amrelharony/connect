...
.lb-schedule-row{display:flex;align-items:center;gap:8px;margin-top:4px}
.lb-schedule-input{background:rgba(0,225,255,.03);border:1px solid var(--border);color:var(--text);
...
@media(max-width:768px){
  ...
  .lb-toolbar{overflow-x:auto;flex-wrap:nowrap;-webkit-overflow-scrolling:touch}
  .lb-toolbar-group{flex-shrink:0}
  .lb-cms-actions{flex-direction:column;gap:10px;align-items:stretch}
  .lb-cms-btn-group{justify-content:stretch}
  .lb-cms-btn{flex:1}
}
@media(max-width:480px){
  ...
  .lb-admin-panel{margin:8px;padding:14px}
  .lb-admin-panel.lb-auth-panel{margin:40px 8px 14px}
  .lb-cms-textarea{min-height:180px;font-size:12px}
