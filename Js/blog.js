...
@media(max-width:768px){
  ...
  .lb-cms-split{grid-template-columns:1fr;min-height:auto}
  .lb-cms-textarea{border-right:none;border-bottom:1px solid var(--border);min-height:200px}
  .lb-cms-preview{max-height:250px}
  .lb-cms-row{grid-template-columns:1fr}
  .lb-admin-panel{margin:12px;padding:16px}
  .lb-admin-panel.lb-auth-panel{margin:60px 16px 20px}
  ...
  .lb-toolbar{overflow-x:auto;flex-wrap:nowrap;-webkit-overflow-scrolling:touch;padding:4px 6px}
  .lb-toolbar-group{flex-shrink:0}
  .lb-tool-btn{padding:6px 8px;min-width:30px}
  .lb-cms-actions{flex-direction:column;gap:10px;align-items:stretch}
  .lb-cms-btn-group{flex-direction:column;gap:6px}
  .lb-cms-btn{flex:1;width:100%;text-align:center}
  .lb-schedule-row{flex-direction:column;align-items:stretch}
  .lb-schedule-input{width:100%}
  .lb-drafts-header{flex-wrap:wrap}
  .lb-draft-row{flex-wrap:wrap;gap:6px}
  .lb-draft-meta{flex-wrap:wrap}
  .lb-cms-article-row{flex-wrap:wrap;gap:6px}
  .lb-cms-article-actions{margin-left:0}
  .lb-sub-tab{font-size:8px;padding:8px 6px;text-align:center}
...
@media(max-width:480px){
  ...
  .lb-admin-panel{margin:6px;padding:10px}
  .lb-admin-panel.lb-auth-panel{margin:40px 8px 14px}
  .lb-cms-textarea{min-height:160px;font-size:12px}
  .lb-cms-preview{max-height:180px;padding:12px}
  .lb-admin-title{font-size:10px;letter-spacing:1px}
  .lb-admin-header{flex-wrap:wrap;gap:8px}
  .lb-admin-close{padding:8px 14px;font-size:10px}
  .lb-cms-tab{padding:10px 10px;font-size:9px;letter-spacing:.5px}
  .lb-cms-input{font-size:11px;padding:8px 10px}
  .lb-cms-label{font-size:8px}
  .lb-tool-btn{padding:5px 6px;font-size:10px;min-width:24px}
  .lb-quick-textarea{min-height:100px;font-size:13px}
  .lb-sub-tab{font-size:7px;padding:7px 4px;letter-spacing:.4px}
}
    ...
    async function renderCMS(passkeyOnly) {
      ...
      <div class="lb-admin-panel">
        ...
        async function submitQuickPost(scheduledAt) {
            ...
            try {
                var result = await window._createMicroblogPost(content, _quickPendFile, scheduledAt || null);
