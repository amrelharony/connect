...
(function() {
    ...
    function initArticleToolbar(articleData) {
        ...
        _toolbarGear.addEventListener('click', function(e) {
            e.stopPropagation();
    ...
    async function renderArticle(slug) {
      ...
      <div class="lb-wrap">
        ...
        document.getElementById('lbBrandHome2').addEventListener('click', e => { e.preventDefault(); B.goToPortfolio(); });
        ...
        <article class="lb-article" itemscope itemtype="https://schema.org/BlogPosting" data-article-id="${data.id}">
          ...
          ${data.cover_image ? `<img class="lb-cover-img lb-reveal" src="${esc(data.cover_image)}" alt="${esc(data.title)}" itemprop="image" loading="lazy">` : ''}
