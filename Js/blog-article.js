        ...
        <article class="lb-article" itemscope itemtype="https://schema.org/BlogPosting" data-article-id="${data.id}">
          ...
          <footer class="lb-article-footer lb-reveal">
            <div class="lb-share-panel">
              ...
              <a class="lb-share-icon linkedin" href="https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(articleUrl)}&summary=${encodeURIComponent(data.excerpt || '')}&title=${encodeURIComponent(data.title)}" target="_blank" rel="noopener" title="Share on LinkedIn" aria-label="Share on LinkedIn"><i class="fa-brands fa-linkedin-in" aria-hidden="true"></i></a>
