...
.gb-globe-btn { font-family:'JetBrains Mono',monospace; font-size:9px; letter-spacing:1.5px; text-transform:uppercase; padding:7px 18px; border-radius:100px; border:1px solid rgba(0,225,255,.2); background:rgba(0,225,255,.06); backdrop-filter:blur(8px); -webkit-backdrop-filter:blur(8px); color:#00e1ff; cursor:pointer; transition:all .25s cubic-bezier(.16,1,.3,1); margin:8px auto 8px; display:inline-flex; align-items:center; gap:6px; text-shadow:0 0 10px rgba(0,225,255,.25); }
.gb-globe-btn:hover { background:rgba(0,225,255,.14); border-color:rgba(0,225,255,.5); transform:translateY(-2px); box-shadow:0 4px 16px rgba(0,225,255,.15); }
...
`;
  ...
  function buildGlobeScene(container) {
    ...
    fetchGlobeStats();
    statsRefreshTimer = setInterval(() => { if (alive) fetchGlobeStats(); }, 30000);
